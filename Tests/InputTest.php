...
class InputTest extends TestCase
{
     ...
     */
    public function testConstructDefaultBehaviour(): void
    {
        $instance = new Input();
     ...
     * @throws \ReflectionException
     */
    public function testConstructDependencyInjection(): void
    {
     ...
     * @covers   \Joomla\Input\Input
     */
    public function testCallProxiesToTheGetMethod(): void
    {
     ...
     * @covers   \Joomla\Input\Input
     */
    public function testCallThrowsAnErrorIfAnUndefinedMethodIsCalled(): void
    {
        $this->expectError();
     ...
     * @covers   \Joomla\Input\Input
     */
    public function testGetCachedInstances(): void
    {
        $instance = $this->getInputObject();
     ...
     */
    public function testGetCachedInstancesSubclasses(): void
    {
        $instance = $this->getInputObject();
     ...
     * @covers   \Joomla\Input\Input
     */
    public function testGetThrowsAnErrorIfAnUndefinedPropertyIsCalled(): void
    {
        $this->expectError();
